class ClusterController < ApplicationController
  ...
  def index
    ...
    if all_list = roma.get_all_routing_list
    ...
    #@inactive_routing_list = all_list - @active_routing_list
    ...
    #render :text => roma.send_command('stats', nil, 'multiplelines_receiver')
    #render :text => @stats_hash
    #render :text => @active_routing_list
    #render :text => all_list
    #render :text => @inactive_routing_list
